...
func init() {
	...
	startCmd.Flags().IntVar(&datastore.Config.LogRetentionDays, "logRetentionDays", 0, "log retention(days)")
	...
	startCmd.Flags().StringVar(&datastore.Config.AnomalyAlgo, "anomalyAlgo", "iforest", "Anomaly detection algorithm (iforest|autoencoder|lstm|lof|knn|mahalanobis|zscore)")
	...
	viper.BindPFlag("logRetentionDays", startCmd.Flags().Lookup("logRetentionDays"))
	...
	viper.BindPFlag("anomalyAlgo", startCmd.Flags().Lookup("anomalyAlgo"))
